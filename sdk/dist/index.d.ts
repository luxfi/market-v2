...
export interface definitions {
    ...
    path: definitions["Model102"][];
    getExecuteBuyV1Response: {
        steps?: definitions["Model101"];
        quote?: number;
    ...
    liquidity: definitions["Model112"][];
    ...
    Model115: {
        ...
        source?: string;
        feeBps?: number;
        feeBreakdown?: definitions["Model114"];
        status?: string;
        expiration: number;
        createdAt: string;
        updatedAt: string;
    ...
    getSearchCollectionsV1Response: {
        collections?: definitions["Model145"];
    };
    Model146: {
        contract?: string;
        tokenId?: string;
    ...
    Model150: {
        ...
        lastSell?: definitions["lastBuy"];
        owner?: string;
        attributes?: definitions["Model149"];
    };
    Model151: {
        id?: string;
        price?: number;
    ...
    Model152: {
        floorAsk?: definitions["Model151"];
        topBid?: definitions["topBid"];
    };
    Model153: {
        token?: definitions["Model150"];
        market?: definitions["Model152"];
    };
    Model154: definitions["Model153"][];
    getTokensDetailsV2Response: {
        tokens?: definitions["Model154"];
        continuation?: string;
    };
    Model155: {
        contract: string;
    ...
    Model160: {
        ...
        lastSell?: definitions["lastBuy"];
        owner?: string;
        attributes?: definitions["Model159"];
    };
    Model161: {
    ...
    getTransfersBulkV1Response: {
        transfers?: definitions["Model165"];
        continuation?: string;
    };
    Model166: {
        type?: string;
    ...
    getCollectionActivityV2Response: {
        continuation?: string;
        activities?: definitions["Model181"];
    };
    Model182: {
        value?: number;
        quantity?: number;
    };
    topBids: definitions["Model182"][];
    ...
    ownersDistribution: definitions["Model183"][];
    ...
    Model187: {
        collection?: definitions["Model184"];
        floorAsk?: definitions["Model185"];
        event?: definitions["Model186"];
    };
    ...
    Model206: {
        ...
        rarityRank?: number;
        media?: string;
        collection?: definitions["Model204"];
        topBid?: definitions["Model205"];
    };
    Model207: {
        id?: string;
        price?: definitions["price"];
    ...
    Model208: {
        tokenCount?: string;
        onSaleCount?: string;
        floorAsk?: definitions["Model207"];
        acquiredAt?: string;
    };
    Model209: {
        token?: definitions["Model206"];
        ownership?: definitions["Model208"];
    };
    Model210: definitions["Model209"][];
    getUserTokensV6Response: {
        tokens?: definitions["Model210"];
        continuation?: string;
    };
    Model211: {
        contract?: string;
    ...
    positions: definitions["Model219"][];
    ...
    Model222: {
        ...
        ownership?: definitions["Model221"];
    };
    Model223: definitions["Model222"][];
    getUserCollectionsV1Response: {
        collections?: definitions["Model223"];
    };
    Model224: {
        type?: string;
        fromAddress?: string;
    ...
    Model227: {
        collection?: definitions["Model226"];
        ownership?: definitions["Model221"];
    };
    Model228: definitions["Model227"][];
    getUserCollectionsV2Response: {
        collections?: definitions["Model228"];
    };
    Model229: {
        id?: string;
        value?: number;
    ...
    Model232: {
        token?: definitions["Model230"];
        ownership?: definitions["Model231"];
    };
    Model233: definitions["Model232"][];
    getUserTokensV1Response: {
        tokens?: definitions["Model233"];
    };
    Model234: {
        id?: string;
        value?: number;
    ...
    Model242: {
        ...
        sampleImages?: definitions["sampleImages"];
        floorAskPrices?: definitions["floorAskPrices"];
        lastBuys?: definitions["Model241"];
        lastSells?: definitions["Model241"];
        topBid?: definitions["topBid"];
    };
    ...
    Model257: {
        ...
        source?: definitions["source"];
        feeBreakdown?: definitions["Model122"];
        context?: definitions["Model120"];
        token?: definitions["Model254"];
    };
    Model258: definitions["Model257"][];
    getUserTopBidsV1Response: {
        totalTokensWithBids?: number;
        topBids?: definitions["Model258"];
        continuation?: string;
    };
    Model259: {
        id?: string;
    ...
    Model282: {
        syncDetails?: definitions["Model281"];
        fromBlock: number;
        toBlock: number;
    ...
    Model288: string[];
    Model289: {
        contracts: definitions["Model288"];
    };
    ...
    Model292: {
        /** @enum {string} */
        kind: "opensea" | "looks-rare" | "zeroex-v4" | "seaport" | "seaport-forward" | "x2y2" | "universe" | "forward" | "infinity";
        data: definitions["source"];
    };
    Model293: {
        order?: definitions["Model292"];
        /**
         * @default reservoir
         * @enum {string}
         */
        orderbook?: "reservoir" | "opensea" | "looks-rare" | "x2y2" | "universe" | "infinity";
    ...
    seaport_offers: definitions["Model297"][];
    Model298: {
    ...
    Model307: {
         ...
         * @enum {string}
         */
        orderKind?: "zeroex-v4" | "seaport" | "looks-rare" | "x2y2" | "universe" | "forward" | "infinity";
        /**
         * @description Orderbook where order is placed. Example: `Reservoir`
         * @default reservoir
         * @enum {string}
    ...
    Model316: {
        ...
        source?: string;
        feesOnTop?: definitions["Model315"];
        /**
    ...
    Model320: {
        orderIds?: definitions["orderIds"];
        rawOrders?: definitions["Model318"];
        tokens?: definitions["Model313"];
        /** @description Quantity of tokens user is buying. Only compatible when buying a single ERC1155 token. Example: `5` */
        quantity?: number;
        /** @description Address of wallet filling the order. Example: `0xF296178d553C8Ec21A2fBD2c5dDa8CA9ac905A00` */
        ...
        /** @description Filling source used for attribution. Example: `reservoir.market` */
        source?: string;
        feesOnTop?: definitions["Model319"];
        /**
         * @description If true, any off-chain or on-chain errors will be skipped.
         * @default false
         */
    ...
    Model326: {
         ...
         * @enum {string}
         */
        orderKind?: "looks-rare" | "zeroex-v4" | "seaport" | "seaport-forward" | "x2y2" | "universe" | "infinity";
        /**
         * @description Orderbook where order is placed. Example: `Reservoir`
         * @default reservoir
         * @enum {string}
         */
        orderbook?: "opensea" | "looks-rare" | "reservoir" | "x2y2" | "universe" | "infinity";
        /** @description Optional API key for the target orderbook */
        orderbookApiKey?: string;
        /**
         * @description If true, royalties will be automatically included.
    ...
    rawOrder: {
        /** @enum {string} */
        kind: "opensea" | "looks-rare" | "zeroex-v4" | "seaport" | "seaport-partial" | "x2y2" | "universe" | "infinity";
        data: definitions["source"];
    };
    /**
     * @description List of fees (formatted as `feeRecipient:feeAmount`) to be taken when filling.
    ...
    getSourcesV1: {
        parameters: {
            query: {
                ...
                /** Order the items are returned in the response. */
                sortDirection?: "asc" | "desc";
                /** Filter to a particular domain. Example: `x2y2` */
                domain?: string;
                /** Amount of items returned in response. */
                limit?: number;
                continuation?: string;
 ...
 */
export function pollUntilHasData(request: AxiosRequestConfig, dataParser: (json: any) => boolean): Promise<any>;
/**
 * Poll the URL with a 5 second interval until it responds with success
 * @param url An URL object
 * @returns When it has finished polling
 */
export function pollUntilOk(request: AxiosRequestConfig, validate?: (res: AxiosResponse) => boolean): Promise<true | undefined>;
/**
 ...
 */
export function isOpenSeaBanned(collectionId: string, tokenId: number | string): Promise<boolean>;
...
type AcceptOfferOptions = Omit<AcceptOfferBodyParameters, 'token' | 'taker'>;
type Data = {
    token: Token;
...
type BuyTokenOptions = Omit<BuyTokenBodyParameters, 'taker' | 'source' | 'tokens' | 'orderIds' | 'rawOrders'>;
